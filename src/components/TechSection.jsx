...
const TECH_DATA = [
  {
    ...
    items: [
      { name: "", url: `${import.meta.env.BASE_URL}brand-audio.png` },
      { name: "", url: `${import.meta.env.BASE_URL}brand-hikvision.png` },
      { name: "", url: `${import.meta.env.BASE_URL}brand-dahua.png` },
      { name: "", url: `${import.meta.env.BASE_URL}brand-multitek.png` },
      { name: "", url: `${import.meta.env.BASE_URL}brand-nade.png` },
      { name: "", url: `${import.meta.env.BASE_URL}brand-visio.png` },
      { name: "", url: `${import.meta.env.BASE_URL}brand-makim.png` },
      { name: "", url: `${import.meta.env.BASE_URL}brand-unv.png` },
    ],
  },
];
